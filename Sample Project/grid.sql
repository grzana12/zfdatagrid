...
insert into `accounts` values('4','Mascker'),
 ('2','Bento'),
 ('5','teste');
...
CREATE TABLE `bugs` (
  ...
  `bug_status` varchar(20) NOT NULL DEFAULT '',
  `reported_by` varchar(100) DEFAULT NULL,
  `next` enum('0','1') NOT NULL DEFAULT '1',
...
insert into `bugs` values('353','Bugggg desc12','Bug Status','4','1','2','4','2010-12-10 23:55:00','2010-12-10','open'),
 ('348','test121','bug status34','','0','','','2010-12-10 23:55:00','2010-12-10','open'),
 ('352','Bugggg desc 11','bug status','','0','','','2010-12-10 23:55:00','2010-12-10','open');
...
insert into `car` values('1','Porsche'),
 ('2','Renault');
...
CREATE TABLE `crud` (
  ...
  `age` int(11) NOT NULL,
  `language` enum('1','2','3') NOT NULL DEFAULT '2',
...
insert into `crud` values('1','filipe11','sa2','10','2','0000-00-00 00:00:00','Afghanistan','boas2@sapo.pt','0',''),
 ('2','filipe11','wdww','10','1','0000-00-00 00:00:00','Afghanistan','boas2@sapo.pt','0','');
...
CREATE TABLE `form` (
  ...
  `sex` enum('Male','Female','Unknown') NOT NULL DEFAULT 'Male',
  `continent` enum('Europe','Asia','America','Oceania','Africa') NOT NULL DEFAULT 'Europe',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

insert into `form` values('5','Carlos Andra','12','Male','Europe'),
 ('4','Carlos Andra1','99','Male','Europe'),
 ('3','Carlos Andra','12','Male','Europe'),
 ('2','Carlos Andra','99','Male','Europe'),
 ('1','Carlos Andra','12','Male','Europe'),
 ('6','Carlos Andra1','99','Male','Europe');
...
insert into `message` values('1','2010-03-15 16:57:00','Bento','Sempre Contigo'),
 ('2','2010-03-15 17:00:45','Bento Vilas Boas','<?php\r\nclass IndexController extends Zend_Controller_Action\r\n{\r\n    public function indexAction()\r\n    {\r\n        $form = $this->getForm();\r\n        $req = $this->getRequest();\r\n        if ($req->getPost() && $form->isValid($req->getPost())) {\r\n          ');

DROP TABLE IF EXISTS `nr_db_profiler`;

CREATE TABLE `nr_db_profiler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `queries_number` int(11) NOT NULL,
  `average` decimal(11,9) NOT NULL,
  `time` decimal(11,9) NOT NULL,
  `per_second` decimal(11,5) NOT NULL,
  `longest` decimal(11,9) NOT NULL,
  `query` text NOT NULL,
...
insert into `products` values('3','Product Name');
...
insert into `unit` values('AFG','Afghanistan','Asia','Southern and Central Asia','652090.00','1919','22720000','45.9','5976.00',null,'Afganistan/Afqanestan','Islamic Emirate','Mohammad Omar','1','AF'),
 ('ALB','Albania','Europe','Southern Europe','28748.00','1912','3401200','71.6','3205.00','2500.00','Shqipëria','Republic','Rexhep Mejdani','34','AL'),
 ('DZA','Algeria','Africa','Northern Africa','2381741.00','1962','31471000','69.7','49982.00','46966.00','Al-Jaza’ir/Algérie','Republic','Abdelaziz Bouteflika','35','DZ'),
 ('ASM','American Samoa','Oceania','Polynesia','199.00',null,'68000','75.1','334.00',null,'Amerika Samoa','US Territory','George W. Bush','54','AS'),
 ('AND','Andorra','Europe','Southern Europe','468.00','1278','78000','83.5','1630.00',null,'Andorra','Parliamentary Coprincipality','','55','AD'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `teste` AS select `products`.`product_name` AS `product_name`,`bugs`.`bug_id` AS `bug_id`,`bugs`.`bug_description` AS `bug_description`,`bugs`.`next` AS `next`,`bugs`.`assigned_to` AS `assigned_to`,`bugs`.`date` AS `date`,`bugs`.`time` AS `time` from ((`bugs` join `bugs_products` on((`bugs`.`bug_id` = `bugs_products`.`bug_id`))) join `products` on((`bugs_products`.`product_id` = `products`.`product_id`))) WITH CASCADED CHECK OPTION;
